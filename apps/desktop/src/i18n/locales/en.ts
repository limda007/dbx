export default {
  ...
  connection: {
    ...
    forceReconnect: "Clear pool & reconnect",
    forceReconnecting: "Reconnecting...",
    forceReconnectHint: "Drop the backend connection pool and reconnect without restarting DBX",
    connected: "Connected",
