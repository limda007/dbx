...
export default withEnglishFallback({
  ...
  connection: {
    ...
    forceReconnect: "Vaciar pool y reconectar",
    forceReconnecting: "Reconectando...",
    forceReconnectHint: "Elimina el pool de conexiones del backend y reconecta sin reiniciar DBX",
    connected: "Conectado",
    ...
    keepaliveDisabledHint: "Keepalive está desactivado. Las VPN, NAT, firewalls o dispositivos en suspensión pueden cerrar silenciosamente las conexiones inactivas.",
